...
import org.chmuche.korm.sql.transactions.DEFAULT_ISOLATION_LEVEL
import org.chmuche.korm.sql.transactions.ThreadLocalTransactionManager
import org.chmuche.korm.sql.transactions.TransactionManager
import org.chmuche.korm.sql.vendors.ANSI_SQL_2003_KEYWORDS
import org.chmuche.korm.sql.vendors.DatabaseDialect
import org.chmuche.korm.sql.vendors.H2Dialect
import org.chmuche.korm.sql.vendors.PostgreSQLDialect
import org.chmuche.korm.sql.vendors.VENDORS_KEYWORDS
...
class Database private constructor(val connector: () -> Connection) {
    ...
    internal val metadata: DatabaseMetaData
        get() = TransactionManager.currentOrNull()?.connection?.metaData ?: with(connector()) {
            try {
                metaData
            } finally {
                close()
    ...
    companion object {
        ...
        init {
            ...
            registerDialect(H2Dialect.dialectName) { PostgreSQLDialect() }
        }
