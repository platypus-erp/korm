package org.chmuche.korm.sql.vendors

import org.chmuche.korm.sql.Column
import org.chmuche.korm.sql.Expression
import org.chmuche.korm.sql.ExpressionWithColumnType
import org.chmuche.korm.sql.ForeignKeyConstraint
import org.chmuche.korm.sql.Index
import org.chmuche.korm.sql.LiteralOp
import org.chmuche.korm.sql.Op
import org.chmuche.korm.sql.QueryBuilder
import org.chmuche.korm.sql.ReferenceOption
...
open class DataTypeProvider {
    ...
    open fun dateType() = "DATE"

    open fun timeType() = "DATETIME"
