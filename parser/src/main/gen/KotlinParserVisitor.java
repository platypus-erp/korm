...
public interface KotlinParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitFuncParameterWithoutDefault(KotlinParser.FuncParameterWithoutDefaultContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#funcParameterWithDefault}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFuncParameterWithDefault(KotlinParser.FuncParameterWithDefaultContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#constructorParameter}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConstructorParameter(KotlinParser.ConstructorParameterContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#constructorParameterWithoutDefault}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConstructorParameterWithoutDefault(KotlinParser.ConstructorParameterWithoutDefaultContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#constructorParameterWithDefault}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConstructorParameterWithDefault(KotlinParser.ConstructorParameterWithDefaultContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitTypealiasDeclaration(KotlinParser.TypealiasDeclarationContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFunctionLiteralparameter(KotlinParser.FunctionLiteralparameterContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitLastArgLambda(KotlinParser.LastArgLambdaContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitInterfaceDeclaration(KotlinParser.InterfaceDeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link KotlinParser#extensionFunctionDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExtensionFunctionDeclaration(KotlinParser.ExtensionFunctionDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#classicFunctionDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassicFunctionDeclaration(KotlinParser.ClassicFunctionDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#lambdaFunction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLambdaFunction(KotlinParser.LambdaFunctionContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#functionParameters}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionParameters(KotlinParser.FunctionParametersContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#modifierAnnotation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitModifierAnnotation(KotlinParser.ModifierAnnotationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link KotlinParser#returnType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReturnType(KotlinParser.ReturnTypeContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitReadonlyPropertyDeclaration(KotlinParser.ReadonlyPropertyDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#mutablePropertyDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMutablePropertyDeclaration(KotlinParser.MutablePropertyDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#lateinitVarPropertyDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLateinitVarPropertyDeclaration(KotlinParser.LateinitVarPropertyDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#extensionPropertyDelegateDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExtensionPropertyDelegateDeclaration(KotlinParser.ExtensionPropertyDelegateDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#readonlyExtensionPropertyNoDelegateDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReadonlyExtensionPropertyNoDelegateDeclaration(KotlinParser.ReadonlyExtensionPropertyNoDelegateDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#parameterType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitParameterType(KotlinParser.ParameterTypeContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#mutableExtensionPropertyNoDelegateDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMutableExtensionPropertyNoDelegateDeclaration(KotlinParser.MutableExtensionPropertyNoDelegateDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#readonlyPropertyNoDelegateDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitReadonlyPropertyNoDelegateDeclaration(KotlinParser.ReadonlyPropertyNoDelegateDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#propertyDelegateDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPropertyDelegateDeclaration(KotlinParser.PropertyDelegateDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#mutablePropertyNoDelegateDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMutablePropertyNoDelegateDeclaration(KotlinParser.MutablePropertyNoDelegateDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#delegateExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDelegateExpression(KotlinParser.DelegateExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#assignExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssignExpression(KotlinParser.AssignExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#getterSetterDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGetterSetterDeclaration(KotlinParser.GetterSetterDeclarationContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitKeyWordModifier(KotlinParser.KeyWordModifierContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link KotlinParser#objectModifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitObjectModifier(KotlinParser.ObjectModifierContext ctx);
	/**
