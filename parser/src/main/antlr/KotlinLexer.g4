...
KeyWordModifier_operator : 'operator';
KeyWordModifier_infix : 'infix';
KeyWordModifier_inline : 'inline';
...
AnnotationUseSiteTarget_field: 'choice';
...
Declaration_fun: 'fun';
Declaration_typealias: 'typealias';
