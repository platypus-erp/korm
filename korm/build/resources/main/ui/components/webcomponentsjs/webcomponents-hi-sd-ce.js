    ...
    (function (a) {
        ...
        function l(a) {
            p(m(a, "template"), function (a) {
                p(m(a.content, 'script:not([type]),script[type="application/javascript"],script[type="text/javascript"]'),
                    function (a) {
        ...
        var z = document.createElement("link"), E = "import" in z, aa = z.querySelectorAll("*"), Qa = null;
        !1 === "currentScript" in document && Object.defineProperty(document, "currentScript",
            {
                get: function () {
                    return Qa || ("complete" !== document.readyState ? document.scripts[document.scripts.length - 1] : null)
                }, configurable: !0
            });
        var ke = /(url\()([^)]*)(\))/g, le = /(@import[\s]+(?!url\())([^;]*)(;)/g,
            me = /(<link[^>]*)(rel=['|"]?stylesheet['|"]?[^>]*>)/g, H = {
                Ea: function (a, b) {
                    ...
                    c = H.va;
                    c || (c = document.implementation.createHTMLDocument("temp"), H.va = c, c.ha = c.createElement("base"), c.head.appendChild(c.ha), c.ga = c.createElement("a"));
                    c.ha.href = b;
                    c.ga.href = a;
                    return c.ga.href || a
                }
            ...
            }, Pa = /Trident/.test(navigator.userAgent) || /Edge\/\d./i.test(navigator.userAgent);
        ...
        k.prototype.m = function (a) {
            ...
            } else this.b++, this.a[c] = "pending", Xb.load(c, function (a, d) {
                a = b.La(a, d || c);
                b.a[c] = a;
                b.b--;
                b.loadImports(a);
        ...
        k.prototype.La = function (a, b) {
            ...
            Pa && (a = a.replace(me, function (a, b, c) {
                return -1 ===
            ...
            if (c = a.querySelector("base")) b = H.U(c.getAttribute("href"), b), c.removeAttribute("href");
        ...
        k.prototype.Na = function (a) {
            ...
            if (d) {
                var e = Pa && !!document.querySelector("link[rel=stylesheet][href][type=import-disable]");
                p(b, function (b) {
                    h(b, function () {
        ...
        var Ra = null;
        if (E) z = m(document, "link[rel=import]"), p(z, function (a) {
            a.import && "loading" === a.import.readyState || (a.__loaded = !0)
        }), z = function (a) {
            a = a.target;
            g(a) && (a.__loaded = !0)
        }, document.addEventListener("load", z, !0), document.addEventListener("error", z, !0); else {
            var ja = Object.getOwnPropertyDescriptor(Node.prototype,
                "baseURI");
            Object.defineProperty((!ja || ja.configurable ? Node : Element).prototype, "baseURI", {
                get: function () {
                    var a = g(this) ? this : c(this);
                    return a ? a.href : ja && ja.get ? ja.get.call(this) : (document.querySelector("base") || window.location).href
...
*/
    ...
    u.la = u.force || !u.Ga;
    var na = navigator.userAgent.match("Trident"), oa = navigator.userAgent.match("Edge");
    ...
    var qa = Element.prototype,
        ra = qa.matches || qa.matchesSelector || qa.mozMatchesSelector || qa.msMatchesSelector || qa.oMatchesSelector || qa.webkitMatchesSelector;
    ...
    var va = document.createTextNode(""), wa = 0, xa = [];
    ...
    function Ha(a) {
        if (a.a) {
            a.a = !1;
            var b = a.takeRecords();
            b.length && a.P.forEach(function (a) {
                a(b)
            })
        }
    }
    ...
    function Ia(a, b) {
        ...
        var d = c.F;
        return {
            wa: b, C: d, za: a, takeRecords: function () {
    ...
    };var x = {}, La = Element.prototype.insertBefore, Ma = Element.prototype.replaceChild,
        Na = Element.prototype.removeChild, Oa = Element.prototype.setAttribute, Sa = Element.prototype.removeAttribute,
        Ta = Element.prototype.cloneNode, Ua = Document.prototype.importNode, Va = Element.prototype.addEventListener,
        Wa = Element.prototype.removeEventListener, Xa = Window.prototype.addEventListener,
        Ya = Window.prototype.removeEventListener, Za = Element.prototype.dispatchEvent,
        $a = Node.prototype.contains || HTMLElement.prototype.contains, ab = Document.prototype.getElementById,
        bb = Element.prototype.querySelector, cb = DocumentFragment.prototype.querySelector,
        db = Document.prototype.querySelector, eb = Element.prototype.querySelectorAll,
        fb = DocumentFragment.prototype.querySelectorAll, gb = Document.prototype.querySelectorAll;
    ...
    function nb(a, b) {
        ...
        for (var c = "", d = b ? b(a) : a.childNodes, e = 0, f = d.length, h; e < f && (h = d[e]); e++) {
            a:{
                ...
                switch (g.nodeType) {
                    case Node.ELEMENT_NODE:
                        for (var m = g.localName, p = "<" + m, z = g.attributes, E = 0; k = z[E]; E++) p += " " + k.name + '="' + k.value.replace(hb, jb) + '"';
                        p += ">";
                        g = lb[m] ? p : p + nb(g, l) + "</" + m + ">";
                        break a;
                    case Node.TEXT_NODE:
        ...
        return c
    };var y = {}, A = document.createTreeWalker(document, NodeFilter.SHOW_ALL, null, !1),
    ...
    var C = {}, pb = u.u, qb = [Node.prototype, Element.prototype, HTMLElement.prototype];
    ...
    var ub = u.u, vb = document.implementation.createHTMLDocument("inert"),
        wb = Object.getOwnPropertyDescriptor(Node.prototype, "isConnected"), xb = wb && wb.get,
        yb = Object.getOwnPropertyDescriptor(Document.prototype, "activeElement"), zb = {
            parentElement: {
                get: function () {
                    var a = t(this);
            ...
            childNodes: {
                    ...
                    switch (this.nodeType) {
                        ...
                        case Node.DOCUMENT_FRAGMENT_NODE:
                            if (!v(this) && ub) {
                                ...
                                (b != this.lastChild || b && b.nodeType != Node.TEXT_NODE) && tb(this);
                                C.ma.textContent.set.call(this, a)
                            } else tb(this), (0 < a.length || this.nodeType === Node.ELEMENT_NODE) && this.appendChild(document.createTextNode(a));
                            break;
                        default:
                            this.nodeValue = a
                    }
                ...
                get: function () {
                    return v(this) ? nb("template" === this.localName ? this.content : this) : G.innerHTML(this)
                }, set: function (a) {
                    ...
                    for (ub ? C.ma.innerHTML.set.call(c, a) : c.innerHTML = a; c.firstChild;) b.appendChild(c.firstChild)
                }, configurable: !0
            }
        }, Cb = {
            shadowRoot: {
            ...
            activeElement: {
                get: function () {
                    var a = yb && yb.get ? yb.get.call(document) : u.u ? void 0 : document.activeElement;
                    if (a && a.nodeType) {
                        var b = !!w(this);
    ...
    function Kb(a, b) {
        var c = r(a);
        if (void 0 === c.firstChild) for (b = b || Ib(a), c.firstChild = b[0] || null, c.lastChild = b[b.length - 1] || null, Hb(a), c = 0; c < b.length; c++) {
            var d = b[c], e = r(d);
            e.parentNode = a;
    ...
    function Mb(a, b, c) {
        ...
        if (c) {
            var d = t(c);
            d = d && d.parentNode;
            if (void 0 !== d && d !== a || void 0 === d && Lb(c) !== a) throw Error("Failed to execute 'insertBefore' on 'Node': The node before which the new node is to be inserted is not a child of this node.");
        }
        if (c === b) return b;
        ...
        if (!b.__noInsertionPoint) {
            ...
            f && (h = e, d = f, h.s = h.s || [], h.f = h.f || [], h.h = h.h || {}, h.s.push.apply(h.s, [].concat(d instanceof Array ? d : ka(ia(d)))))
        }
        ...
        g || (g = w(a) ? a.host : a, c ? (c = Qb(c), x.insertBefore.call(g, b, c)) : x.appendChild.call(g, b));
        Rb(a, b);
        return b
    }
    ...
    function Nb(a, b) {
            ...
            if (c.f) {
                ...
                for (aa in f) for (h = f[aa], g = 0; g < h.length; g++) {
                    ...
                    if (Aa(b, l)) {
                        ...
                        g--;
                        m = t(l);
                        if (l = m.A) for (var p = 0; p < l.length; p++) {
                            var z = l[p], E = Ub(z);
        ...
        k || (k = w(a) ? a.host : a, (!d.root && "slot" !== b.localName || k === Lb(b)) && x.removeChild.call(k, b));
        Rb(a, null, b);
        return b
    }
    ...
    function Qb(a) {
        var b = a;
        a && "slot" === a.localName && (b = (b = (b = t(a)) && b.A) && b.length ? b[0] : Qb(a.nextSibling));
        return b
    }
    ...
    function Wb(a, b) {
        if ("slot" === b) a = a.parentNode, Pb(a) && Ob(t(a).root); else if ("slot" === a.localName && "name" === b && (b = pa(a))) {
            if (b.f) {
                var c = a.ua, d = Yb(a);
                if (d !== c) {
                    c = b.h[c];
    ...
    function Rb(a, b, c) {
        if (a = (a = t(a)) && a.F) b && a.addedNodes.push(b), c && a.removedNodes.push(c), Ga(a)
    }

    function $b(a) {
        if (a && a.nodeType) {
            var b = r(a), c = b.I;
            void 0 === c && (w(a) ? (c = a, b.I = c) : (c = (c = a.parentNode) ? $b(c) : a, x.contains.call(document.documentElement, a) && (b.I = c)));
            return c
        }
    }
    ...
    function dc(a, b, c) {
        ...
        cc && "class" === b ? cc.setElementClass(a, c) : (x.setAttribute.call(a, b, c), Wb(a, b))
    }
    ...
    function ec(a, b) {
        ...
        return c
    };var fc = "__eventWrappers" + Date.now(), gc = {
        blur: !0,
        focus: !0,
        focusin: !0,
        focusout: !0,
    ...
    function nc(a, b, c) {
        if (c = b.__handlers && b.__handlers[a.type] && b.__handlers[a.type][c]) for (var d = 0, e; (e = c[d]) && (!mc(a) || a.target !== a.relatedTarget) && (e.call(b, a), !a.g); d++) ;
    }
    ...
    function oc(a) {
        ...
        for (c = 0; c < b.length; c++) {
            ...
            var f = t(d);
            f = f && f.root;
            if (0 === c || f && f === e) if (nc(a, d, "bubble"), d !== window && (e = d.getRootNode()), a.a) break
        }
    }

    function pc(a, b, c, d, e, f) {
        for (var h = 0; h < a.length; h++) {
            var g = a[h], k = g.type, l = g.capture, m = g.once, p = g.passive;
        ...
        if (b) {
            ...
            if ("function" === d || "object" === d) if ("object" !== d || b.handleEvent && "function" === typeof b.handleEvent) {
                ...
                k = function (e) {
                    ...
                    if (e.composed || -1 < e.composedPath().indexOf(g)) if (mc(e) && e.target === e.relatedTarget) e.eventPhase === Event.BUBBLING_PHASE && e.stopImmediatePropagation(); else if (e.eventPhase === Event.CAPTURING_PHASE || e.bubbles || e.target === g || g instanceof Window) {
                ...
                b[fc].push({node: g, type: a, capture: e, once: f, passive: h, Wa: k});
                lc[a] ? (this.__handlers =
                    this.__handlers || {}, this.__handlers[a] = this.__handlers[a] || {
                    capture: [],
                    bubble: []
                }, this.__handlers[a][e ? "capture" : "bubble"].push(k)) : (this instanceof Window ? x.Ua : x.addEventListener).call(this, a, k, c)
            }
        }
    }
    ...
    function sc(a, b, c) {
        if (b) {
            ...
            var h = c && c.Z || this, g = void 0;
            var k = null;
            try {
                k = b[fc]
            } catch (l) {
            }
            k && (e = pc(k, h, a, d, e, f), -1 < e && (g = k.splice(e, 1)[0].Wa, k.length || (b[fc] = void 0)));
            (this instanceof Window ? x.Va : x.removeEventListener).call(this, a, g || b, c);
            g && lc[a] && this.__handlers && this.__handlers[a] && (a = this.__handlers[a][d ? "capture" : "bubble"], g = a.indexOf(g), -1 < g && a.splice(g, 1))
        }
    }

    function tc() {
        for (var a in lc) window.addEventListener(a, function (a) {
    ...
    var uc = kc(window.Event), vc = kc(window.CustomEvent), wc = kc(window.MouseEvent);
    ...
    function yc(a, b, c, d) {
        ...
        for (l = 1; l < d; l++) for (m = 1; m < g; m++) if (a[k + m - 1] === c[h + l - 1]) b[l][m] =
            b[l - 1][m - 1]; else {
            var p = b[l - 1][m] + 1, z = b[l][m - 1] + 1;
            b[l][m] = p < z ? p : z
        }
        k = b.length - 1;
        h = b[0].length - 1;
        d = b[k][h];
        for (a = []; 0 < k || 0 < h;) 0 == k ? (a.push(2), h--) : 0 == h ? (a.push(3), k--) : (g = b[k - 1][h - 1], l = b[k - 1][h], m = b[k][h - 1], p = l < m ? l < g ? l : g : m < g ? m : g, p == g ? (g == d ? a.push(0) : (a.push(1), d = g), k--, h--) : p == l ? (a.push(3), k--, d = l) : (a.push(2), h--, d = m));
        a.reverse();
        b = void 0;
        k = [];
    ...
    function zc(a, b) {
        return a === b
    };var Ub = G.parentNode, Ac = G.childNodes, Bc = {};
    ...
    Fb.prototype._renderRoot = function () {
        ...
        if (this.f) {
            ...
            for (var a = 0, b; a < this.f.length; a++) {
                b = this.f[a];
                var c = t(b), d = c.assignedNodes;
                c.assignedNodes = [];
                c.A = [];
                if (c.da = d) for (c = 0; c < d.length; c++) {
                    var e = t(d[c]);
                    e.M = e.assignedSlot;
            ...
            for (a = 0; a < this.f.length; a++) {
                b = this.f[a];
                d = t(b);
                if (!d.assignedNodes.length) for (c = b.firstChild; c; c = c.nextSibling) Ec(this, c, b);
            ...
            a = this.f;
            b = [];
            for (d = 0; d < a.length; d++) c = a[d].parentNode, (e = t(c)) && e.root || !(0 > b.indexOf(c)) || b.push(c);
            for (a = 0; a < b.length; a++) {
                ...
                for (var k = g = 0; g < h.length && (d = h[g]); g++) {
                    for (var l = 0, m; l < d.J.length && (m = d.J[l]); l++) Ub(m) === c && x.removeChild.call(c, m), f.splice(d.index + k, 1);
                    k -= d.O
                }
                for (k = 0; k < h.length && (d = h[k]); k++) for (g = f[d.index], l = d.index; l < d.index + d.O; l++) m = e[l], x.insertBefore.call(c, m, g), f.splice(l, 0, m)
            }
        }
    };
    ...
    var Ic = {addEventListener: qc.bind(window), removeEventListener: sc.bind(window)}, Jc = {
        addEventListener: qc, removeEventListener: sc, appendChild: function (a) {
            return Mb(this, a)
    ...
    Object.defineProperties(Jc, {
        isConnected: {
            get: function () {
                ...
                for (a = this; a && !(a instanceof Document);) a = a.parentNode || (w(a) ? a.host : void 0);
    ...
    var Pc = HTMLElement.prototype.blur, Qc = ta({
        blur: function () {
            var a = t(this);
    ...
    if (u.la) {
        ...
        K(window.DocumentFragment.prototype,
            Lc);
        K(window.Element.prototype, Nc);
        K(window.Document.prototype, Oc);
        window.HTMLSlotElement && K(window.HTMLSlotElement.prototype, Mc);
        K(Sc.prototype, Qc);
        u.u && (J(window.Node.prototype), J(window.Text.prototype), J(window.DocumentFragment.prototype), J(window.Element.prototype), J(Sc.prototype), J(window.Document.prototype), window.HTMLSlotElement && J(window.HTMLSlotElement.prototype));
        Eb();
        ...
        for (var d = a; d;) {
            if (d.nodeType === Node.ELEMENT_NODE) {
                ...
                if ("link" === f && "import" === e.getAttribute("rel")) {
                    d = e.import;
                    if (d instanceof Node && !c.has(d)) for (c.add(d), d = d.firstChild; d; d = d.nextSibling) M(d, b, c);
                    d = Vc(a, e);
                    continue
                } else if ("template" === f) {
                    d = Vc(a, e);
    ...
    function Q(a, b, c) {
        c = void 0 === c ? {} : c;
        var d = c.Ta || new Set, e = c.V || function (b) {
            return $c(a, b)
        }, f = [];
        M(b, function (b) {
    ...
    ad.prototype.b = function (a) {
        ...
        for (b = 0; b < a.length; b++) for (var c = a[b].addedNodes, d = 0; d < c.length; d++) Q(this.i, c[d])
    };
    ...
    n.define = function (a, b) {
        ...
        if (this.i.a.get(a)) throw Error("A custom element with name '" + a + "' has already been defined.");
        ...
        Xc(this.i, a, b);
        this.ca.push(b);
        this.L || (this.L = !0, this.ba(function () {
            return dd(c)
        }))
    };
    n.V = function (a) {
    ...
    function dd(a) {
        if (!1 !== a.L) {
            a.L = !1;
            for (var b = a.ca, c = [], d = new Map, e = 0; e < b.length; e++) d.set(b[e].localName, []);
            Q(a.i, document, {
                V: function (b) {
                    if (void 0 === b.__CE_state) {
    ...
    n.ra = function (a) {
        ...
        b = new bd;
        this.ea.set(a, b);
        this.i.a.get(a) && !this.ca.some(function (b) {
    ...
    var ed = window.Document.prototype.createElement, fd = window.Document.prototype.createElementNS,
        gd = window.Document.prototype.importNode, hd = window.Document.prototype.prepend,
        id = window.Document.prototype.append, jd = window.DocumentFragment.prototype.prepend,
        kd = window.DocumentFragment.prototype.append, ld = window.Node.prototype.cloneNode,
        md = window.Node.prototype.appendChild, nd = window.Node.prototype.insertBefore,
        od = window.Node.prototype.removeChild, pd = window.Node.prototype.replaceChild,
        qd = Object.getOwnPropertyDescriptor(window.Node.prototype,
            "textContent"), rd = window.Element.prototype.attachShadow,
        sd = Object.getOwnPropertyDescriptor(window.Element.prototype, "innerHTML"),
        td = window.Element.prototype.getAttribute, ud = window.Element.prototype.setAttribute,
        vd = window.Element.prototype.removeAttribute, wd = window.Element.prototype.getAttributeNS,
        xd = window.Element.prototype.setAttributeNS, yd = window.Element.prototype.removeAttributeNS,
        zd = window.Element.prototype.insertAdjacentElement, Ad = window.Element.prototype.insertAdjacentHTML,
        Bd = window.Element.prototype.prepend,
        Cd = window.Element.prototype.append, Dd = window.Element.prototype.before, Ed = window.Element.prototype.after,
        Fd = window.Element.prototype.replaceWith, Gd = window.Element.prototype.remove, Hd = window.HTMLElement,
        Id = Object.getOwnPropertyDescriptor(window.HTMLElement.prototype, "innerHTML"),
        Jd = window.HTMLElement.prototype.insertAdjacentElement, Kd = window.HTMLElement.prototype.insertAdjacentHTML;
    var Ld = new function () {
    };
    ...
    function Md() {
        ...
        window.HTMLElement = function () {
            function b() {
                ...
                if (0 === e.length) return e = ed.call(document, d.localName), Object.setPrototypeOf(e, b.prototype), e.__CE_state = 1, e.__CE_definition = d, a.b(e), e;
                d = e.length - 1;
                var f = e[d];
                if (f === Ld) throw Error("The HTMLElement constructor was either called reentrantly for this constructor or called multiple times.");
                e[d] = Ld;
    ...
    function Od(a, b, c) {
        function d(b) {
            return function (c) {
                ...
                if (L(this)) for (d = 0; d < e.length; d++) f = e[d], f instanceof Element && O(a, f)
            }
        }
    ...
    function Qd() {
        ...
        N(Node.prototype, "cloneNode", function (b) {
            b = ld.call(this, b);
            this.ownerDocument.__CE_hasRegistry ? Q(a, b) :
                Zc(a, b);
            return b
        });
        N(Node.prototype, "removeChild", function (b) {
            var c = L(b), e = od.call(this, b);
            c && P(a, b);
            return e
        });
        N(Node.prototype, "replaceChild", function (b, d) {
            ...
            c = L(b);
            var f = pd.call(this, b, d), h = L(this);
            h && P(a, d);
            c && P(a, b);
            h && O(a, b);
            return f
        });
        qd && qd.get ? b(Node.prototype, qd) : Yc(a, function (a) {
            b(a, {
    ...
    function Rd(a) {
        ...
        function c(b) {
            return function (c) {
                ...
                if (L(this)) for (d = 0; d < e.length; d++) g = e[d], g instanceof Element && O(a, g)
            }
        }
        ...
        Fd && N(b, "replaceWith", function (b) {
            ...
            if (g) for (P(a, this), c = 0; c < d.length; c++) h = d[c], h instanceof Element && O(a, h)
        });
        void 0 !== Gd && N(b, "remove", function () {
            var b = L(this);
            Gd.call(this);
            b && P(a, this)
        })
    ...
    function Sd() {
        ...
        function d(b, c) {
            ...
            N(b, "insertAdjacentHTML", function (a, b) {
                ...
                } else if ("afterbegin" === a) e = this.firstChild, c.call(this, a, b), d(this.firstChild, e); else if ("beforeend" === a) e = this.lastChild, c.call(this, a, b), d(e || this.firstChild, null); else if ("afterend" === a) e = this.nextSibling, c.call(this,
                    a, b), d(this.nextSibling, e); else throw new SyntaxError("The value provided (" + String(a) + ") is not one of 'beforebegin', 'afterbegin', 'beforeend', or 'afterend'.");
            })
        }

        rd && N(Element.prototype, "attachShadow", function (a) {
            return this.__CE_shadowRoot = a = rd.call(this, a)
        });
        sd && sd.get ? b(Element.prototype, sd) : Id && Id.get ? b(HTMLElement.prototype, Id) : Yc(a, function (a) {
            b(a, {
                enumerable: !0, configurable: !0, get: function () {
                    return ld.call(this, !0).innerHTML
                }, set: function (a) {
                    var b = "template" === this.localName, c = b ? this.content :
                        this, d = ed.call(document, this.localName);
                    for (d.innerHTML = a; 0 < c.childNodes.length;) od.call(c, c.childNodes[0]);
                    for (a = b ? d.content : d; 0 < a.childNodes.length;) md.call(c, a.childNodes[0])
                }
            })
        });
        ...
        Jd ?
            c(HTMLElement.prototype, Jd) : zd ? c(Element.prototype, zd) : console.warn("Custom Elements: `Element#insertAdjacentElement` was not patched.");
        Kd ? d(HTMLElement.prototype, Kd) : Ad ? d(Element.prototype, Ad) : console.warn("Custom Elements: `Element#insertAdjacentHTML` was not patched.");
        Od(a, Element.prototype, {T: Bd, append: Cd});
        Rd(a)
    };var Td = window.customElements;
    if (!Td || Td.forcePolyfill || "function" != typeof Td.define || "function" != typeof Td.get) {
        var Nd = new Wc;
        Md();
        Pd();
...
*/
    ...
    function Yd(a, b) {
        ...
        a.parent && (c = b.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1), c = Zd(c), c = c.replace($d, " "), c = c.substring(c.lastIndexOf(";") + 1), c = a.parsedSelector = a.selector = c.trim(), a.atRule = 0 === c.indexOf("@"), a.atRule ? 0 === c.indexOf("@media") ? a.type = ae : c.match(be) && (a.type = ce, a.keyframesName = a.selector.split($d).pop()) : a.type = 0 === c.indexOf("--") ? de : ee);
        if (c = a.rules) for (var d = 0, e = c.length, f; d < e && (f = c[d]); d++) Yd(f,
            b);
        return a
    }
    ...
    function fe(a, b, c) {
        ...
        if (a.cssText || a.rules) {
            ...
            } else b ? b = a.cssText : (b = a.cssText, b = b.replace(ge, "").replace(he, ""), b = b.replace(ie, "").replace(je, "")), (d = b.trim()) && (d = "  " + d + "\n")
        }
        d && (a.selector && (c += a.selector + " {\n"), c += d, a.selector && (c += "}\n\n"));
        return c
    }

    var ee = 1, ce = 7, ae = 4, de = 1E3, Wd = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim, Xd = /@import[^;]*;/gim,
        ge = /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,
        he = /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim,
        ie = /@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim, je = /[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim,
        be = /^@[^\s]*keyframes/, $d = /\s+/g;
    var S = !(window.ShadyDOM && window.ShadyDOM.inUse), ne;

    function oe(a) {
        ne = a && a.shimcssproperties ? !1 : S || !(navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/) || !window.CSS || !CSS.supports || !CSS.supports("box-shadow", "0 0 0 var(--foo)"))
    }

    window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss ? ne = window.ShadyCSS.nativeCss : window.ShadyCSS ? (oe(window.ShadyCSS), window.ShadyCSS = void 0) : oe(window.WebComponents && window.WebComponents.flags);
    var T = ne;
    var pe = /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi,
        qe = /(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi, re = /(--[\w-]+)\s*([:,;)]|$)/gi,
        se = /(animation\s*:)|(animation-name\s*:)/, te = /@media\s(.*)/, ue = /\{[^}]*\}/g;
    var ve = new Set;
    ...
    function He(a, b, c) {
        if (b) if (a.classList) c ? (a.classList.remove("style-scope"), a.classList.remove(b)) : (a.classList.add("style-scope"), a.classList.add(b)); else if (a.getAttribute) {
            ...
            c ? d && (b = d.replace("style-scope", "").replace(b, ""), De(a, b)) : De(a, (d ? d + " " : "") + "style-scope " + b)
        }
    }

    function Je(a, b, c) {
        var d = W, e = a.__cssBuild;
        S || "shady" === e ? b = we(b, c) : (a = V(a), b = Ke(d, b, a.is, a.K, c) + "\n\n");
        return b.trim()
    }
    ...
    Ee.prototype.b = function (a, b, c) {
        ...
        a = a.trim();
        var e = Qe.test(a);
        e && (a = a.replace(Qe, function (a, b, c) {
    ...
    function We(a, b) {
        var c = a.match(af);
        return (c = c && c[2].trim() || "") ? c[0].match(bf) ? a.replace(af, function (a, c, f) {
            return b + f
        }) : c.split(bf)[0] === b ? c : cf : a.replace(Se, b)
    }
    ...
    var Qe = /:(nth[-\w]+)\(([^)]+)\)/, ff = ":not(.style-scope)", Oe = ",",
        Te = /(^|[\s>+~]+)((?:\[.+?\]|[^\s>+~=[])+)/g, bf = /[[.:#*]/, Se = ":host", ef = ":root", Ve = "::slotted",
        Re = new RegExp("^(" + Ve + ")"), af = /(:host)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/,
        Ye = /(?:::slotted)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/, Ze = /(.*):dir\((?:(ltr|rtl))\)/, Me = ".", $e = ":",
        Ie = "class", cf = "should_not_match", W = new Ee;
    ...
    function pf(a, b, c) {
        b && (b = 0 <= b.indexOf(";") ? qf(a, b, c) : Ce(b, function (b, e, f, h) {
            if (!e) return b + h;
            (e = pf(a, c[e], c)) && "initial" !== e ? "apply-shim-inherit" === e && (e = "inherit") : e = pf(a, c[f] || f, c) || f;
            return b + (e || "") + h
        }));
        return b && b.trim() || ""
    }
    ...
    function qf(a, b, c) {
        ...
        for (var d = 0, e, f; d < b.length; d++) if (e = b[d]) {
            qe.lastIndex = 0;
            if (f = qe.exec(e)) e = pf(a, c[f[1]], c); else if (f = e.indexOf(":"), -1 !== f) {
                var h = e.substring(f);
                h = h.trim();
                h = pf(a, h, c) || h;
                e = e.substring(0, f) + h
    ...
    function rf(a, b) {
        ...
        xe(a, function (a) {
            ...
            b && a.j.v && e && jf.call(b, e) && (of(a, c), a = a.index, e = parseInt(a / 32, 10), d[e] = (d[e] || 0) | 1 << a % 32)
        }, null, !0);
        return {v: c, key: d}
    }
    ...
    function sf(a, b, c, d) {
        ...
        if (b.j.v) {
            ...
            if (h || g) c = e, g && (b.l || (b.l = Ne(W, b, W.b, a ? Me + a : "", e)), c = b.l || e), d({
                Qa: c,
                Ja: g,
                ib: h
            })
    ...
    function uf(a, b, c, d) {
        ...
        return Je(b, e, function (b) {
            ...
            if (!S && !ze(b) && b.cssText) {
                ...
                if (b.ka) if (null == b.S) {
                    b.S = [];
                    for (var p in g) k = g[p], k = k(e), e !== k && (e = k, b.S.push(p))
                } else {
                ...
                p = b.l.split(",");
                k = 0;
                for (var z = p.length, E; k < z && (E = p[k]); k++) p[k] = E.match(h) ? E.replace(f, e) : e + " " + E;
                b.selector = p.join(",")
            }
        })
    }
    ...
    function vf(a, b) {
        a = a.b;
        var c = {};
        if (!S && a) for (var d = 0, e = a[d]; d < a.length; e = a[++d]) {
            var f = e, h = b;
    ...
    function xf(a, b) {
        ...
        a.textContent = we(d, function (a) {
            ...
            a.j && a.j.cssText && (d = d.replace(ge, "").replace(he, ""), a.cssText = qf(c, d, b))
        })
    }
    ...
    var yf = new lf;
    var zf = {}, Af = window.customElements;
    if (Af && !S) {
        var Bf = Af.define;
        ...
        for (var b = 0; b < a.length; b++) {
            ...
            if (c.target !== document.documentElement && c.target !== document.head) for (var d = 0; d < c.addedNodes.length; d++) {
                ...
                if (e.nodeType === Node.ELEMENT_NODE) {
                    ...
                    h = g;
                    g = h.indexOf(W.a);
                    if ((h = -1 < g ? h[g + 1] : "") && f === e.ownerDocument) Fe(e, h, !0); else if (f.nodeType === Node.DOCUMENT_FRAGMENT_NODE &&
    ...
    if (!S) {
        var Ff = new MutationObserver(Ef), Gf = function (a) {
            Ff.observe(a, {childList: !0, subtree: !0})
        };
        if (window.customElements && !window.customElements.polyfillWrapFlushCallback) Gf(document); else {
            var Hf = function () {
                Gf(document.body)
            };
            window.HTMLImports ? window.HTMLImports.whenReady(Hf) : requestAnimationFrame(function () {
    ...
    function Lf(a) {
        if (a = Jf[a]) a._applyShimCurrentVersion = a._applyShimCurrentVersion || 0, a._applyShimValidatingVersion = a._applyShimValidatingVersion || 0, a._applyShimNextVersion = (a._applyShimNextVersion || 0) + 1
    }
    ...
    function Nf(a) {
        ...
        a.a || (a.a = !0, Kf.then(function () {
            a._applyShimCurrentVersion = a._applyShimNextVersion;
            a.a = !1
        }))
    };var Of = null, Pf = window.HTMLImports && window.HTMLImports.whenReady || null, Qf;

    function Rf(a) {
        requestAnimationFrame(function () {
            Pf ? Pf(a) : (Of || (Of = new Promise(function (a) {
                Qf = a
            }), "complete" === document.readyState ? Qf() : document.addEventListener("readystatechange", function () {
        ...
        if (!a.b) {
            ...
            for (var f = a.content.querySelectorAll("style"), h = 0; h < f.length; h++) {
                ...
                if (g.hasAttribute("shady-unscoped")) {
                    if (!S) {
                        var k = g.textContent;
                        ve.has(k) || (ve.add(k), k = g.cloneNode(!0), document.head.appendChild(k));
            ...
            d = [];
            T || (d = mf(a._styleAst));
            if (!d.length || T) e = S ? a.content : null, b = zf[b], f = Je(c, a._styleAst), b = f.length ? Ae(f, c.is, e, b) : void 0, a.ja = b;
            a.Aa = d
        }
    };
    ...
    function Tf(a) {
        !a.a && window.ShadyCSS && window.ShadyCSS.ApplyShim && (a.a = window.ShadyCSS.ApplyShim, a.a.invalidCallback = Lf);
        Uf(a)
    }
    ...
    n.D = function () {
        ...
        if (this.b) {
            ...
            if (this.b.enqueued) {
                ...
                } else for (Vf(this, this.c, this.g), b = 0; b < a.length; b++) (c = this.b.getStyleForCustomStyle(a[b])) && xf(c, this.g.B);
                this.b.enqueued = !1;
    ...
    n.styleElement = function (a, b) {
        ...
        if (T) {
            ...
            if (((k = Jf[c]) || a === this.c) && k && k.ja && !Mf(k)) {
                if (Mf(k) || k._applyShimValidatingVersion !== k._applyShimNextVersion) Tf(this), this.a && this.a.transformRules(k._styleAst, c), k.ja.textContent =
                    Je(a, d.w), Nf(k);
                S && (c = a.shadowRoot) && (c.querySelector("style").textContent = Je(a, d.w));
                d.w = k._styleAst
            }
            ...
            h = c.o;
            (g = b && b.o) || (g = this.H[k] = (this.H[k] || 0) + 1, g = k + "-" + g);
            c.o = g;
            g = c.o;
            e = yf;
            ...
            f = X(a);
            var l = f.a;
            l && !S && l !== d && (l._useCount--, 0 >= l._useCount && l.parentNode && l.parentNode.removeChild(l));
            S ? f.a ? (f.a.textContent = e, d = f.a) : e && (d = Ae(e, g, a.shadowRoot, f.b)) : d ? d.parentNode ||
                (kf && -1 < e.indexOf("@media") && (d.textContent = e), Be(d, null, f.b)) : e && (d = Ae(e, g, null, f.b));
            d && (d._useCount = d._useCount || 0, f.a != d && d._useCount++, f.a = d);
            g = d;
            S || (d = c.o, f = e = a.getAttribute("class") || "", h && (f = e.replace(new RegExp("\\s*x-scope\\s*" + h + "\\s*", "g"), " ")), f += (f ? " " : "") + "x-scope " + d, e !== f && De(a, f));
    ...
    var Z = new Y, Xf, Yf;
    window.ShadyCSS && (Xf = window.ShadyCSS.ApplyShim, Yf = window.ShadyCSS.CustomStyleInterface);
    window.ShadyCSS = {
 ...
 subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
    var Zf = window.customElements, $f = window.HTMLImports, ag = window.HTMLTemplateElement;
    ...
    eg.textContent = "body {transition: opacity ease-in 0.2s; } \nbody[unresolved] {opacity: 0; display: block; overflow: hidden; position: relative; } \n";
