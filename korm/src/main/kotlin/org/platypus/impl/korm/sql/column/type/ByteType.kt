...
class BinaryColumnType(val length: Int, required: Boolean = false) : ColumnType(required) {
    override val modelColumnType = ModelColumnType.BINARY
...
class BlobColumnType(required: Boolean = false) : ColumnType(required) {
    override val modelColumnType = ModelColumnType.BLOB
...
class BooleanColumnType(required: Boolean = false) : ColumnType(required) {
    override val modelColumnType = ModelColumnType.BOOLEAN
