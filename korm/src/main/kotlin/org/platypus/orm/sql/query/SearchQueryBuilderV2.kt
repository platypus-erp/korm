...
interface SearchQueryBuilderV2<M : Model<M>> {
    ...
    fun adjustSelect(slice : FieldUnaryPlus.(M) -> Unit): SearchQueryBuilderV2<M>
    ...
    fun where(predicate: FieldGetter.(M) -> Expression<Boolean>): SearchQueryBuilderV2<M>
    fun or(predicate: FieldGetter.(M) -> Expression<Boolean>): SearchQueryBuilderV2<M>
    fun and(predicate: FieldGetter.(M) -> Expression<Boolean>): SearchQueryBuilderV2<M>
