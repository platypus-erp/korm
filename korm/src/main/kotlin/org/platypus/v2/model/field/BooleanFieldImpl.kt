...
class BooleanFieldImpl<M : BaseModel<M>>(
        override val fieldName: String,
        override val model: M) : BooleanField<M> {
    ...
    override var help: String? = null
        private set
    override var defaultValueFun: ((env: PlatypusEnvironment) -> Boolean?) = { null }
        private set
    ...
    override var widget: UIWidget? = null
        private set
    override var constraint: Set<OrmConstraint<Boolean>> = emptySet()
        private set
    override var transformer: Set<FieldTransformer<Boolean>> = emptySet()
        private set
    ...
    class Builder<M : BaseModel<M>> constructor(val model: M, val fieldName: String) : BooleanField.Builder<M> {
        ...
        override var widget: UIWidget? = null
        override var constraint: MutableSet<OrmConstraint<Boolean>> = mutableSetOf()
        override var transformer: MutableSet<FieldTransformer<Boolean>> = mutableSetOf()
        override var readonly: Boolean? = null
        override var required: Boolean? = null
        override var store: Boolean? = null

        override fun build(): BooleanField<M> {
            return BooleanFieldImpl(fieldName, model).apply {
