...
class WriteUserFieldImpl<M : BaseModel<M>>(override val model: M) : WriteUserField<M> {

    override val fieldName: String = "write_uid"
    override val label: String? = "This Record is updated by"
