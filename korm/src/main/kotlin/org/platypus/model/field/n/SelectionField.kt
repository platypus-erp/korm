...
interface SelectionField<M : IModel<M>, T : Any> : ClassicField<M, T>, IndexableField {

    interface Builder<M : IModel<M>> : FieldBuilder<M, LocalDate, DateField<M>>, IndexableField.Mutable
}