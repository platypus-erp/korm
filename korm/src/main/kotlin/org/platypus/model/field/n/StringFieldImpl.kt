...
class StringFieldImpl<M : IModel<M>>(
        override val fieldName: String,
        override val model: M) : StringField<M> {
    ...
    class Builder<M : IModel<M>> constructor(val model: M, val fieldName: String) : StringField.Builder<M> {
        ...
        override fun build(): StringField<M> {
            return StringFieldImpl(fieldName, model).apply {
