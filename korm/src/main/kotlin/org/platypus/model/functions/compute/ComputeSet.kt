...
class ComputeSetExtends<M : Model<M>, P>(
...
class ComputeSetOriginal<M : Model<M>, P>
...
class ComputeSetStacker<M : Model<M>, P : Any>(originalFunction: (Record<M>, P) -> Unit, private val field: ModelField<M, P>
