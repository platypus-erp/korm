...
*/
    ...
    u.ha = u.force || !u.ya;
    var la = navigator.userAgent.match("Trident"), ma = navigator.userAgent.match("Edge");
    ...
    var na = Element.prototype,
        oa = na.matches || na.matchesSelector || na.mozMatchesSelector || na.msMatchesSelector || na.oMatchesSelector || na.webkitMatchesSelector;
    ...
    var ta = document.createTextNode(""), ua = 0, va = [];
    ...
    function Ga(a, b) {
        ...
        var d = c.F;
        return {
            qa: b, B: d, ta: a, takeRecords: function () {
    ...
    };var y = {}, Ja = Element.prototype.insertBefore, Ka = Element.prototype.replaceChild,
        La = Element.prototype.removeChild, Ma = Element.prototype.setAttribute, Na = Element.prototype.removeAttribute,
        Oa = Element.prototype.cloneNode, Pa = Document.prototype.importNode, Qa = Element.prototype.addEventListener,
        Ra = Element.prototype.removeEventListener, Sa = Window.prototype.addEventListener,
        Ta = Window.prototype.removeEventListener, Ua = Element.prototype.dispatchEvent,
        Va = Node.prototype.contains || HTMLElement.prototype.contains, Wa = Document.prototype.getElementById,
        Xa = Element.prototype.querySelector, Ya = DocumentFragment.prototype.querySelector,
        Za = Document.prototype.querySelector, $a = Element.prototype.querySelectorAll,
        ab = DocumentFragment.prototype.querySelectorAll, bb = Document.prototype.querySelectorAll;
    ...
    function ib(a, b) {
        ...
        for (var c = "", d = b ? b(a) : a.childNodes, e = 0, f = d.length, g; e < f && (g = d[e]); e++) {
            a:{
                ...
                switch (h.nodeType) {
                    case Node.ELEMENT_NODE:
                        for (var m = h.localName, q = "<" + m, O = h.attributes, L = 0; k = O[L]; L++) q += " " + k.name + '="' + k.value.replace(cb, eb) + '"';
                        q += ">";
                        h = gb[m] ? q : q + ib(h, l) + "</" + m + ">";
                        break a;
                    case Node.TEXT_NODE:
        ...
        return c
    };var z = {}, A = document.createTreeWalker(document, NodeFilter.SHOW_ALL, null, !1),
    ...
    var C = {}, kb = u.s, lb = [Node.prototype, Element.prototype, HTMLElement.prototype];
    ...
    var pb = u.s, qb = document.implementation.createHTMLDocument("inert"),
        rb = Object.getOwnPropertyDescriptor(Node.prototype, "isConnected"), sb = rb && rb.get,
        tb = Object.getOwnPropertyDescriptor(Document.prototype, "activeElement"), ub = {
            parentElement: {
                get: function () {
                    var a = t(this);
            ...
            childNodes: {
                    ...
                    switch (this.nodeType) {
                        ...
                        case Node.DOCUMENT_FRAGMENT_NODE:
                            if (!v(this) && pb) {
                                ...
                                (b != this.lastChild || b && b.nodeType != Node.TEXT_NODE) && ob(this);
                                C.ia.textContent.set.call(this, a)
                            } else ob(this), (0 < a.length || this.nodeType === Node.ELEMENT_NODE) && this.appendChild(document.createTextNode(a));
                            break;
                        default:
                            this.nodeValue = a
                    }
                ...
                get: function () {
                    ...
                    for (pb ? C.ia.innerHTML.set.call(c, a) : c.innerHTML = a; c.firstChild;) b.appendChild(c.firstChild)
                }, configurable: !0
            }
        }, xb = {
            shadowRoot: {
            ...
            activeElement: {
                get: function () {
                    var a = tb && tb.get ? tb.get.call(document) : u.s ? void 0 : document.activeElement;
                    if (a && a.nodeType) {
                        var b = !!w(this);
                        if (this === document || b && this.host !== a && y.contains.call(this.host, a)) {
    ...
    function Fb(a, b) {
        var c = r(a);
        if (void 0 === c.firstChild) for (b = b || Db(a), c.firstChild = b[0] || null, c.lastChild = b[b.length - 1] || null, Cb(a), c = 0; c < b.length; c++) {
            var d = b[c], e = r(d);
            e.parentNode = a;
    ...
    function Hb(a, b, c) {
        ...
        if (c) {
            var d = t(c);
            d = d && d.parentNode;
            if (void 0 !== d && d !== a || void 0 === d && Gb(c) !== a) throw Error("Failed to execute 'insertBefore' on 'Node': The node before which the new node is to be inserted is not a child of this node.");
        }
        if (c === b) return b;
        ...
        if (!b.__noInsertionPoint) {
            if (f = e = x(a)) {
                var g;
                "slot" === b.localName ? g = [b] : b.querySelectorAll &&
                    (g = b.querySelectorAll("slot"));
        ...
        h || (h = w(a) ? a.host : a, c ? (c = Lb(c), y.insertBefore.call(h, b, c)) : y.appendChild.call(h, b));
        Mb(a, b);
        return b
    }
    ...
    function Ib(a, b) {
        ...
        if (v(a)) {
            ...
            var g = e.previousSibling, h = e.nextSibling;
            g && (r(g).nextSibling = h);
        ...
        if (c) {
            ...
            if (c.f) {
                Ob(c);
                f = c.g;
                for (ra in f) for (g = f[ra], h = 0; h < g.length; h++) {
                    var l = g[h];
                    if (ya(b, l)) {
                        g.splice(h, 1);
                        var m = c.f.indexOf(l);
                        ...
                        h--;
                        m = t(l);
                        if (l = m.w) for (var q = 0; q < l.length; q++) {
                            var O = l[q], L = Pb(O);
        ...
        k || (k = w(a) ? a.host : a, (!d.root && "slot" !== b.localName || k === Gb(b)) && y.removeChild.call(k, b));
        Mb(a, null, b);
        return b
    }
    ...
    function Lb(a) {
        var b = a;
        a && "slot" === a.localName && (b = (b = (b = t(a)) && b.w) && b.length ? b[0] : Lb(a.nextSibling));
        return b
    }
    ...
    function Ub(a) {
        if (a && a.nodeType) {
            var b = r(a), c = b.H;
            void 0 === c && (w(a) ? (c = a, b.H = c) : (c = (c = a.parentNode) ? Ub(c) : a, y.contains.call(document.documentElement, a) && (b.H = c)));
            return c
        }
    }
    ...
    function Yb(a, b, c) {
        ...
        Xb && "class" === b ? Xb.setElementClass(a, c) : (y.setAttribute.call(a, b, c), Rb(a, b))
    }
    ...
    function Zb(a, b) {
        ...
        return c
    };var $b = "__eventWrappers" + Date.now(), ac = {
        blur: !0,
        focus: !0,
        focusin: !0,
        focusout: !0,
    ...
    function cc(a, b) {
        if (!w) return a;
        a = bc(a, !0);
        for (var c = 0, d, e, f, g; c < b.length; c++) if (d = b[c], f = d === window ? window : d.getRootNode(), f !== e && (g = a.indexOf(f), e = f), !w(f) || -1 < g) return d
    }
    ...
    function ic(a) {
        ...
        for (c = 0; c < b.length; c++) {
            ...
            var f = t(d);
            f = f && f.root;
            if (0 === c || f && f === e) if (hc(a, d, "bubble"), d !== window && (e = d.getRootNode()), a.a) break
        }
    }
    ...
    function kc(a, b, c) {
        if (b) {
            ...
            if ("function" === d || "object" === d) if ("object" !== d || b.handleEvent && "function" === typeof b.handleEvent) {
                ...
                b[$b].push({node: h, type: a, capture: e, once: f, passive: g, Ja: k});
                fc[a] ? (this.__handlers =
                    this.__handlers || {}, this.__handlers[a] = this.__handlers[a] || {
                    capture: [],
                    bubble: []
                }, this.__handlers[a][e ? "capture" : "bubble"].push(k)) : (this instanceof Window ? y.Ha : y.addEventListener).call(this, a, k, c)
            }
        }
    }
    ...
    function mc(a, b, c) {
        if (b) {
            ...
            var g = c && c.X || this, h = void 0;
            var k = null;
            try {
                k = b[$b]
            } catch (l) {
            }
            k && (e = jc(k, g, a, d, e, f), -1 < e && (h = k.splice(e, 1)[0].Ja, k.length || (b[$b] = void 0)));
            (this instanceof Window ? y.Ia : y.removeEventListener).call(this, a, h || b, c);
            h && fc[a] && this.__handlers && this.__handlers[a] && (a = this.__handlers[a][d ? "capture" : "bubble"], h = a.indexOf(h), -1 < h && a.splice(h, 1))
        }
    }

    function nc() {
        for (var a in fc) window.addEventListener(a, function (a) {
    ...
    var oc = ec(window.Event), pc = ec(window.CustomEvent), qc = ec(window.MouseEvent);
    ...
    function tc(a, b) {
        return a === b
    };var Pb = F.parentNode, uc = F.childNodes, vc = {};
    ...
    Ab.prototype._renderRoot = function () {
        ...
        if (this.f) {
            ...
            for (var a = 0, b; a < this.f.length; a++) {
                ...
                c.assignedNodes = [];
                c.w = [];
                if (c.aa = d) for (c = 0; c < d.length; c++) {
                    var e = t(d[c]);
                    e.L = e.assignedSlot;
            ...
            for (a = 0; a < this.f.length; a++) {
                b = this.f[a];
                d = t(b);
                if (!d.assignedNodes.length) for (c = b.firstChild; c; c = c.nextSibling) yc(this, c, b);
            ...
            for (a = 0; a < b.length; a++) {
                ...
                for (var k = h = 0; h < g.length && (d = g[h]); h++) {
                    for (var l = 0, m; l < d.I.length && (m = d.I[l]); l++) Pb(m) === c && y.removeChild.call(c, m), f.splice(d.index + k, 1);
                    k -= d.N
                }
                for (k = 0; k < g.length && (d = g[k]); k++) for (h = f[d.index], l = d.index; l < d.index + d.N; l++) m = e[l], y.insertBefore.call(c, m, h), f.splice(l, 0, m)
            }
        }
    };
    ...
    var Cc = {addEventListener: kc.bind(window), removeEventListener: mc.bind(window)}, Dc = {
        addEventListener: kc, removeEventListener: mc, appendChild: function (a) {
            return Hb(this, a)
    ...
    var Jc = HTMLElement.prototype.blur, Kc = qa({
        blur: function () {
            var a = t(this);
    ...
    if (u.ha) {
        ...
        nc();
        var Mc = window.customElements && window.customElements.nativeHTMLElement || HTMLElement;
        I(Ab.prototype, Lc);
        I(window.Node.prototype, Dc);
        I(window.Window.prototype, Cc);
        I(window.Text.prototype, Ec);
        I(window.DocumentFragment.prototype,
            Fc);
        I(window.Element.prototype, Hc);
        I(window.Document.prototype, Ic);
        window.HTMLSlotElement && I(window.HTMLSlotElement.prototype, Gc);
        I(Mc.prototype, Kc);
        u.s && (H(window.Node.prototype), H(window.Text.prototype), H(window.DocumentFragment.prototype), H(window.Element.prototype), H(Mc.prototype), H(window.Document.prototype), window.HTMLSlotElement && H(window.HTMLSlotElement.prototype));
        zb();
        window.ShadowRoot = Ab
    }
    ;var Nc = new Set("annotation-xml color-profile font-face font-face-src font-face-uri font-face-format font-face-name missing-glyph".split(" "));
    ...
    function Q(a, b, c) {
        c = void 0 === c ? {} : c;
        var d = c.Ga || new Set, e = c.T || function (b) {
            return Uc(a, b)
        }, f = [];
        K(b, function (b) {
    ...
    function Vc(a) {
        ...
        this.B = void 0;
        Q(this.h, this.a);
        "loading" === this.a.readyState && (this.B = new MutationObserver(this.b.bind(this)), this.B.observe(this.a, {
            childList: !0,
            subtree: !0
        }))
    }
    ...
    Vc.prototype.b = function (a) {
        ...
        for (b = 0; b < a.length; b++) for (var c = a[b].addedNodes, d = 0; d < c.length; d++) Q(this.h, c[d])
    };
    ...
    n.define = function (a, b) {
        ...
        if (!Oc(a)) throw new SyntaxError("The element name '" + a + "' is not valid.");
    ...
    function Zc(a) {
        if (!1 !== a.K) {
            a.K = !1;
            for (var b = a.$, c = [], d = new Map, e = 0; e < b.length; e++) d.set(b[e].localName, []);
            Q(a.h, document, {
                T: function (b) {
                    if (void 0 === b.__CE_state) {
    ...
    n.ma = function (a) {
        if (!Oc(a)) return Promise.reject(new SyntaxError("'" + a + "' is not a valid custom element name."));
        var b = this.ba.get(a);
        if (b) return b.c;
        b = new Xc;
        this.ba.set(a, b);
        this.h.a.get(a) && !this.$.some(function (b) {
    ...
    var $c = window.Document.prototype.createElement, ad = window.Document.prototype.createElementNS,
        bd = window.Document.prototype.importNode, cd = window.Document.prototype.prepend,
        dd = window.Document.prototype.append, ed = window.DocumentFragment.prototype.prepend,
        fd = window.DocumentFragment.prototype.append, gd = window.Node.prototype.cloneNode,
        hd = window.Node.prototype.appendChild, id = window.Node.prototype.insertBefore,
        jd = window.Node.prototype.removeChild, kd = window.Node.prototype.replaceChild,
        ld = Object.getOwnPropertyDescriptor(window.Node.prototype,
            "textContent"), md = window.Element.prototype.attachShadow,
        nd = Object.getOwnPropertyDescriptor(window.Element.prototype, "innerHTML"),
        od = window.Element.prototype.getAttribute, pd = window.Element.prototype.setAttribute,
        qd = window.Element.prototype.removeAttribute, rd = window.Element.prototype.getAttributeNS,
        sd = window.Element.prototype.setAttributeNS, td = window.Element.prototype.removeAttributeNS,
        ud = window.Element.prototype.insertAdjacentElement, vd = window.Element.prototype.insertAdjacentHTML,
        wd = window.Element.prototype.prepend,
        xd = window.Element.prototype.append, yd = window.Element.prototype.before, zd = window.Element.prototype.after,
        ...
        Ed = window.HTMLElement.prototype.insertAdjacentElement, Fd = window.HTMLElement.prototype.insertAdjacentHTML;
    var Gd = new function () {
    };
    ...
    function Hd() {
        ...
        window.HTMLElement = function () {
            function b() {
                var b = this.constructor, d = a.D.get(b);
                if (!d) throw Error("The custom element being constructed was not registered with `customElements`.");
                var e = d.constructionStack;
                if (0 === e.length) return e = $c.call(document, d.localName), Object.setPrototypeOf(e, b.prototype), e.__CE_state = 1, e.__CE_definition = d, a.b(e), e;
                d = e.length - 1;
                var f = e[d];
                if (f === Gd) throw Error("The HTMLElement constructor was either called reentrantly for this constructor or called multiple times.");
                e[d] = Gd;
    ...
    function Jd(a, b, c) {
        function d(b) {
            return function (c) {
                ...
                if (J(this)) for (e = 0; e < d.length; e++) f = d[e], f instanceof Element && N(a, f)
            }
        }
    ...
    function Ld() {
        ...
        M(Node.prototype, "replaceChild", function (b, d) {
            ...
            c = J(b);
            var f = kd.call(this, b, d), g = J(this);
            g && P(a, d);
            c && P(a, b);
            g && N(a, b);
            return f
    ...
    function Md(a) {
        ...
        function c(b) {
            return function (c) {
                ...
                if (J(this)) for (d = 0; d < e.length; d++) h = e[d], h instanceof Element && N(a, h)
            }
        }
        ...
        Ad && M(b, "replaceWith", function (b) {
            ...
            if (h) for (P(a, this), c = 0; c < d.length; c++) g = d[c], g instanceof Element && N(a, g)
        });
    ...
    function Nd() {
            ...
            b(a, {
                enumerable: !0, configurable: !0, get: function () {
                    ...
                    var b = "template" === this.localName, c = b ? this.content :
                        this, d = $c.call(document, this.localName);
                    for (d.innerHTML = a; 0 < c.childNodes.length;) jd.call(c, c.childNodes[0]);
                    for (a = b ? d.content : d; 0 < a.childNodes.length;) hd.call(c, a.childNodes[0])
                }
            })
        });
        ...
        Ed ?
            c(HTMLElement.prototype, Ed) : ud ? c(Element.prototype, ud) : console.warn("Custom Elements: `Element#insertAdjacentElement` was not patched.");
        Fd ? d(HTMLElement.prototype, Fd) : vd ? d(Element.prototype, vd) : console.warn("Custom Elements: `Element#insertAdjacentHTML` was not patched.");
...
*/
    ...
    if (!Od || Od.forcePolyfill || "function" != typeof Od.define || "function" != typeof Od.get) {
        var Id = new Qc;
        Hd();
        Kd();
...
*/
    ...
    function Td(a, b) {
        ...
        a.parent && (c = b.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1), c = Ud(c), c = c.replace(Vd, " "), c = c.substring(c.lastIndexOf(";") + 1), c = a.parsedSelector = a.selector = c.trim(), a.atRule = 0 === c.indexOf("@"), a.atRule ? 0 === c.indexOf("@media") ? a.type = Wd : c.match(Xd) && (a.type = Yd, a.keyframesName = a.selector.split(Vd).pop()) : a.type = 0 === c.indexOf("--") ? Zd : $d);
        if (c = a.rules) for (var d = 0, e = c.length, f; d < e && (f = c[d]); d++) Td(f,
            b);
        return a
    }
    ...
    var $d = 1, Yd = 7, Wd = 4, Zd = 1E3, Rd = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim, Sd = /@import[^;]*;/gim,
        be = /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,
        ce = /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim,
        de = /@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim, ee = /[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim,
        Xd = /^@[^\s]*keyframes/, Vd = /\s+/g;
    var S = !(window.ShadyDOM && window.ShadyDOM.inUse), fe;
    ...
    window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss ? fe = window.ShadyCSS.nativeCss : window.ShadyCSS ? (ge(window.ShadyCSS), window.ShadyCSS = void 0) : ge(window.WebComponents && window.WebComponents.flags);
    var T = fe;
    var he = /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi,
        ie = /(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi, je = /(--[\w-]+)\s*([:,;)]|$)/gi,
        ke = /(animation\s*:)|(animation-name\s*:)/, le = /@media\s(.*)/, me = /\{[^}]*\}/g;
    var ne = new Set;
    ...
    function ze(a, b, c) {
        if (b) if (a.classList) c ? (a.classList.remove("style-scope"), a.classList.remove(b)) : (a.classList.add("style-scope"), a.classList.add(b)); else if (a.getAttribute) {
            ...
            c ? d && (b = d.replace("style-scope", "").replace(b, ""), ve(a, b)) : ve(a, (d ? d + " " : "") + "style-scope " + b)
        }
    }

    function Be(a, b, c) {
        var d = W, e = a.__cssBuild;
        S || "shady" === e ? b = oe(b, c) : (a = V(a), b = Ce(d, b, a.is, a.J, c) + "\n\n");
        return b.trim()
    }
    ...
    we.prototype.b = function (a, b, c) {
        ...
        a = a.trim();
        var e = Ie.test(a);
        e && (a = a.replace(Ie, function (a, b, c) {
    ...
    function Oe(a, b) {
        var c = a.match(Te);
        return (c = c && c[2].trim() || "") ? c[0].match(Ue) ? a.replace(Te, function (a, c, f) {
            return b + f
    ...
    var Ie = /:(nth[-\w]+)\(([^)]+)\)/, Ye = ":not(.style-scope)", Ge = ",",
        Le = /(^|[\s>+~]+)((?:\[.+?\]|[^\s>+~=[])+)/g, Ue = /[[.:#*]/, Ke = ":host", Xe = ":root", Ne = "::slotted",
        Je = new RegExp("^(" + Ne + ")"), Te = /(:host)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/,
        Qe = /(?:::slotted)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/, Re = /(.*):dir\((?:(ltr|rtl))\)/, Ee = ".", Se = ":",
        Ae = "class", Ve = "should_not_match", W = new we;
    ...
    function gf(a, b, c) {
        b && (b = 0 <= b.indexOf(";") ? hf(a, b, c) : ue(b, function (b, e, f, g) {
            if (!e) return b + g;
            (e = gf(a, c[e], c)) && "initial" !== e ? "apply-shim-inherit" === e && (e = "inherit") : e = gf(a, c[f] || f, c) || f;
            return b + (e || "") + g
        }));
        return b && b.trim() || ""
    }
    ...
    function hf(a, b, c) {
        ...
        for (var d = 0, e, f; d < b.length; d++) if (e = b[d]) {
            ie.lastIndex = 0;
            if (f = ie.exec(e)) e = gf(a, c[f[1]], c); else if (f = e.indexOf(":"), -1 !== f) {
                var g = e.substring(f);
                g = g.trim();
                g = gf(a, g, c) || g;
                e = e.substring(0, f) + g
    ...
    function jf(a, b) {
        ...
        pe(a, function (a) {
            ...
            b && a.j.u && e && af.call(b, e) && (ff(a, c), a = a.index, e = parseInt(a / 32, 10), d[e] = (d[e] || 0) | 1 << a % 32)
        }, null, !0);
        return {u: c, key: d}
    }
    ...
    function kf(a, b, c, d) {
        ...
        if (b.j.u) {
            ...
            if (g || h) c = e, h && (b.l || (b.l = Fe(W, b, W.b, a ? Ee + a : "", e)), c = b.l || e), d({
                Da: c,
                Aa: h,
                Va: g
            })
    ...
    function mf(a, b, c, d) {
        ...
        return Be(b, e, function (b) {
            ...
            if (!S && !re(b) && b.cssText) {
                ...
                if (b.ga) if (null == b.R) {
                    b.R = [];
                    for (var q in h) k = h[q], k = k(e), e !== k && (e = k, b.R.push(q))
                } else {
                ...
                q = b.l.split(",");
                k = 0;
                for (var O = q.length, L; k < O && (L = q[k]); k++) q[k] = L.match(g) ? L.replace(f, e) : e + " " + L;
                b.selector = q.join(",")
            }
        })
    }
    ...
    function pf(a, b) {
        ...
        a.textContent = oe(d, function (a) {
            ...
            a.j && a.j.cssText && (d = d.replace(be, "").replace(ce, ""), a.cssText = hf(c, d, b))
        })
    }
    ...
    var qf = new cf;
    var rf = {}, sf = window.customElements;
    if (sf && !S) {
        var tf = sf.define;
        ...
        for (var b = 0; b < a.length; b++) {
            ...
            if (c.target !== document.documentElement && c.target !== document.head) for (var d = 0; d < c.addedNodes.length; d++) {
                ...
                if (e.nodeType === Node.ELEMENT_NODE) {
                    ...
                    g = h;
                    h = g.indexOf(W.a);
                    if ((g = -1 < h ? g[h + 1] : "") && f === e.ownerDocument) xe(e, g, !0); else if (f.nodeType === Node.DOCUMENT_FRAGMENT_NODE &&
    ...
    if (!S) {
        var xf = new MutationObserver(wf), yf = function (a) {
    ...
    function Ff(a) {
        ...
        a.a || (a.a = !0, Cf.then(function () {
            a._applyShimCurrentVersion = a._applyShimNextVersion;
            a.a = !1
        }))
    };var Gf = null, Hf = window.HTMLImports && window.HTMLImports.whenReady || null, If;
        ...
        if (!a.b) {
            ...
            for (var f = a.content.querySelectorAll("style"), g = 0; g < f.length; g++) {
                ...
                if (h.hasAttribute("shady-unscoped")) {
                    if (!S) {
                        var k = h.textContent;
                        ne.has(k) || (ne.add(k), k = h.cloneNode(!0), document.head.appendChild(k));
            ...
            d = [];
            T || (d = df(a._styleAst));
            if (!d.length || T) e = S ? a.content : null, b = rf[b], f = Be(c, a._styleAst), b = f.length ? se(f, c.is, e, b) : void 0, a.ea = b;
            a.ua = d
        }
    };
    ...
    function Lf(a) {
        !a.a && window.ShadyCSS && window.ShadyCSS.ApplyShim && (a.a = window.ShadyCSS.ApplyShim, a.a.invalidCallback = Df);
        Mf(a)
    }
    ...
    n.C = function () {
        ...
        if (this.b) {
            ...
            if (this.b.enqueued) {
                ...
                } else for (Nf(this, this.c, this.i), b = 0; b < a.length; b++) (c = this.b.getStyleForCustomStyle(a[b])) && pf(c, this.i.A);
                this.b.enqueued = !1;
    ...
    n.styleElement = function (a, b) {
        ...
        if (T) {
            ...
            if (((k = Bf[c]) || a === this.c) && k && k.ea && !Ef(k)) {
                if (Ef(k) || k._applyShimValidatingVersion !== k._applyShimNextVersion) Lf(this), this.a && this.a.transformRules(k._styleAst, c), k.ea.textContent =
                    Be(a, d.v), Ff(k);
                S && (c = a.shadowRoot) && (c.querySelector("style").textContent = Be(a, d.v));
                d.v = k._styleAst
            }
            ...
            g = c.m;
            (h = b && b.m) || (h = this.fa[k] = (this.fa[k] || 0) + 1, h = k + "-" + h);
            c.m = h;
            h = c.m;
            e = qf;
            ...
            S ? f.a ? (f.a.textContent = e, d = f.a) : e && (d = se(e, h, a.shadowRoot, f.b)) : d ? d.parentNode ||
                (bf && -1 < e.indexOf("@media") && (d.textContent = e), te(d, null, f.b)) : e && (d = se(e, h, null, f.b));
            d && (d._useCount = d._useCount || 0, f.a != d && d._useCount++, f.a = d);
            h = d;
            S || (d = c.m, f = e = a.getAttribute("class") || "", g && (f = e.replace(new RegExp("\\s*x-scope\\s*" + g + "\\s*", "g"), " ")), f += (f ? " " : "") + "x-scope " + d, e !== f && ve(a, f));
    ...
    var Z = new Y, Pf, Qf;
    window.ShadyCSS && (Pf = window.ShadyCSS.ApplyShim, Qf = window.ShadyCSS.CustomStyleInterface);
    window.ShadyCSS = {
