...
*/
    ...
    (function () {
        ...
        var f = Node.prototype.cloneNode, h = Document.prototype.createElement, g = Document.prototype.importNode,
            ...
            t = Document.prototype.querySelectorAll, C = DocumentFragment.prototype.querySelectorAll, aa = function () {
                if (!c) {
        ...
        if (c) {
            var P = document.implementation.createHTMLDocument("template"), Ka = !0,
            ...
            a.H = function (b) {
                if (!b.content && b.namespaceURI === document.documentElement.namespaceURI) {
                    ...
                    if (D) b.__proto__ = a.prototype; else if (b.cloneNode = function (b) {
                            return a.ha(this, b)
                        }, Ka) try {
                        va(b), ja(b)
                    } catch (rh) {
        ...
        if (c || aa) {
            ...
            var ya = function (c, d) {
                ...
                if (!e && d && this instanceof DocumentFragment) if (b) var c = jf.call(this.ownerDocument, this, !0); else return this.ownerDocument.createDocumentFragment(); else c =
    ...
    var pa = 0, qa, ra = "undefined" !== typeof window ? window : void 0, sa = ra || {},
    ...
    function ib(a, b) {
        ...
        this.D = new a(Qa);
        this.D[Ra] || Sa(this.D);
        if (oa(b)) if (this.U = this.length = b.length, this.f = Array(this.length), 0 === this.length) r(this.D, this.f); else {
    ...
    function v(a) {
        ...
        if (Qa !== a) {
            ...
            if (this instanceof v) gb(this, a); else throw new TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.");
        }
    }

    v.prototype = {
        constructor: v, then: Pa, a: function (a) {
...
*/
    ...
    (function (a) {
        ...
        var Ka = /(url\()([^)]*)(\))/g, ba = /(@import[\s]+(?!url\())([^;]*)(;)/g,
            La = /(<link[^>]*)(rel=['|"]?stylesheet['|"]?[^>]*>)/g, D = {
                Pa: function (a, b) {
        ...
        if (C) t = m(document, "link[rel=import]"), n(t, function (a) {
            ...
            a = a.target;
            g(a) && (a.__loaded = !0)
        }, document.addEventListener("load", t, !0), document.addEventListener("error", t, !0); else {
...
*/
    ...
    function Vb(a, b) {
        ...
        var d = c.J;
        return {
            Ga: b, G: d, Ka: a, takeRecords: function () {
    ...
    };var B = {}, Yb = Element.prototype.insertBefore, Zb = Element.prototype.replaceChild,
        $b = Element.prototype.removeChild, ac = Element.prototype.setAttribute, bc = Element.prototype.removeAttribute,
        cc = Element.prototype.cloneNode, dc = Document.prototype.importNode, ec = Element.prototype.addEventListener,
        fc = Element.prototype.removeEventListener, gc = Window.prototype.addEventListener,
        hc = Window.prototype.removeEventListener, ic = Element.prototype.dispatchEvent,
        jc = Node.prototype.contains || HTMLElement.prototype.contains, kc = Document.prototype.getElementById,
        lc = Element.prototype.querySelector, mc = DocumentFragment.prototype.querySelector,
        nc = Document.prototype.querySelector, oc = Element.prototype.querySelectorAll,
        pc = DocumentFragment.prototype.querySelectorAll, qc = Document.prototype.querySelectorAll;
    ...
    function xc(a, b) {
        ...
        return c
    };var E = {}, F = document.createTreeWalker(document, NodeFilter.SHOW_ALL, null, !1),
    ...
    var Ec = z.w, Fc = document.implementation.createHTMLDocument("inert"),
        Gc = Object.getOwnPropertyDescriptor(Node.prototype, "isConnected"), Hc = Gc && Gc.get,
        Ic = Object.getOwnPropertyDescriptor(Document.prototype, "activeElement"), Jc = {
            parentElement: {
                get: function () {
                    var a = y(this);
    ...
    function gd(a, b) {
        if ("slot" === b) a = a.parentNode, $c(a) && Zc(y(a).root); else if ("slot" === a.localName && "name" === b && (b = Cb(a))) {
            if (b.g) {
                var c = a.Ea, d = hd(a);
                if (d !== c) {
                    c = b.j[c];
    ...
    function od(a, b) {
        ...
        return c
    };var pd = "__eventWrappers" + Date.now(), qd = {
        blur: !0,
        focus: !0,
        focusin: !0,
        focusout: !0,
        ...
        if (b) {
            ...
            if ("function" === d || "object" === d) if ("object" !== d || b.handleEvent && "function" === typeof b.handleEvent) {
                ...
                k = function (e) {
                    ...
                    if (e.composed || -1 < e.composedPath().indexOf(g)) if (wd(e) && e.target === e.relatedTarget) e.eventPhase === Event.BUBBLING_PHASE && e.stopImmediatePropagation(); else if (e.eventPhase === Event.CAPTURING_PHASE || e.bubbles || e.target === g || g instanceof Window) {
    ...
    Qc.prototype._renderRoot = function () {
        ...
        if (this.g) {
            ...
            for (a = 0; a < b.length; a++) {
                ...
                for (k = 0; k < h.length && (d = h[k]); k++) for (g = f[d.index], l = d.index; l < d.index + d.W; l++) m = e[l], B.insertBefore.call(c, m, g), f.splice(l, 0, m)
            }
        }
    };
    ...
    var Sd = {addEventListener: Ad.bind(window), removeEventListener: Cd.bind(window)}, Td = {
        addEventListener: Ad, removeEventListener: Cd, appendChild: function (a) {
            return Xc(this, a)
            ...
            if ("template" == this.localName) var b = B.cloneNode.call(this, a); else if (b = B.cloneNode.call(this, !1), a) {
                a = this.childNodes;
    ...
    var Zd = HTMLElement.prototype.blur, $d = Gb({
        blur: function () {
            var a = y(this);
    ...
    var oe = window.Document.prototype.createElement, pe = window.Document.prototype.createElementNS,
        qe = window.Document.prototype.importNode, re = window.Document.prototype.prepend,
        se = window.Document.prototype.append, te = window.DocumentFragment.prototype.prepend,
        ue = window.DocumentFragment.prototype.append, ve = window.Node.prototype.cloneNode,
        we = window.Node.prototype.appendChild, xe = window.Node.prototype.insertBefore,
        ye = window.Node.prototype.removeChild, ze = window.Node.prototype.replaceChild,
        Ae = Object.getOwnPropertyDescriptor(window.Node.prototype,
            "textContent"), Be = window.Element.prototype.attachShadow,
        Ce = Object.getOwnPropertyDescriptor(window.Element.prototype, "innerHTML"),
        De = window.Element.prototype.getAttribute, Ee = window.Element.prototype.setAttribute,
        Fe = window.Element.prototype.removeAttribute, Ge = window.Element.prototype.getAttributeNS,
        He = window.Element.prototype.setAttributeNS, Ie = window.Element.prototype.removeAttributeNS,
        Je = window.Element.prototype.insertAdjacentElement, Ke = window.Element.prototype.insertAdjacentHTML,
        Le = window.Element.prototype.prepend,
        Me = window.Element.prototype.append, Ne = window.Element.prototype.before, Oe = window.Element.prototype.after,
        Pe = window.Element.prototype.replaceWith, Qe = window.Element.prototype.remove, Re = window.HTMLElement,
        Se = Object.getOwnPropertyDescriptor(window.HTMLElement.prototype, "innerHTML"),
        Te = window.HTMLElement.prototype.insertAdjacentElement, Ue = window.HTMLElement.prototype.insertAdjacentHTML;
    var Ve = new function () {
    };
    ...
    function Ye(a, b, c) {
        function d(b) {
            return function (c) {
                ...
                if (N(this)) for (d = 0; d < e.length; d++) f = e[d], f instanceof Element && Q(a, f)
            }
        }
    ...
    function af(a) {
        ...
        function c(b) {
            return function (c) {
                ...
                if (N(this)) for (d = 0; d < e.length; d++) g = e[d], g instanceof Element && Q(a, g)
            }
        }
        ...
        Pe && O(b, "replaceWith", function (b) {
            ...
            if (g) for (R(a, this), c = 0; c < d.length; c++) h = d[c], h instanceof Element && Q(a, h)
        });
            ...
            b(a, {
                enumerable: !0, configurable: !0, get: function () {
                    ...
                    var b = "template" === this.localName, c = b ? this.content :
                        this, d = oe.call(document, this.localName);
    ...
    function kf(a, b) {
        ...
        if (c = a.rules) for (var d = 0, e = c.length, f; d < e && (f = c[d]); d++) kf(f,
            b);
        return a
    }
    ...
    var rf = 1, pf = 7, nf = 4, qf = 1E3, ff = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim, gf = /@import[^;]*;/gim,
        tf = /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,
        uf = /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim,
        vf = /@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim, wf = /[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim,
    ...
    var zf = /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi,
        Af = /(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi, Bf = /(--[\w-]+)\s*([:,;)]|$)/gi,
        Cf = /(animation\s*:)|(animation-name\s*:)/, Df = /@media\s(.*)/, Ef = /\{[^}]*\}/g;
    var Ff = new Set;
    ...
    var bg = /:(nth[-\w]+)\(([^)]+)\)/, rg = ":not(.style-scope)", $f = ",",
        eg = /(^|[\s>+~]+)((?:\[.+?\]|[^\s>+~=[])+)/g, ng = /[[.:#*]/, dg = ":host", qg = ":root", gg = "::slotted",
        cg = new RegExp("^(" + gg + ")"), mg = /(:host)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/,
        jg = /(?:::slotted)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/, kg = /(.*):dir\((?:(ltr|rtl))\)/, Yf = ".", lg = ":",
        Uf = "class", og = "should_not_match", W = new Qf;
    ...
    function Bg(a, b, c) {
        ...
        for (var d = 0, e, f; d < b.length; d++) if (e = b[d]) {
            Af.lastIndex = 0;
            if (f = Af.exec(e)) e = Ag(a, c[f[1]], c); else if (f = e.indexOf(":"), -1 !== f) {
                var h = e.substring(f);
                h = h.trim();
                h = Ag(a, h, c) || h;
                e = e.substring(0, f) + h
        ...
        for (var b = 0; b < a.length; b++) {
            ...
            if (c.target !== document.documentElement && c.target !== document.head) for (var d = 0; d < c.addedNodes.length; d++) {
                ...
                if (e.nodeType === Node.ELEMENT_NODE) {
                    ...
                    h = g;
                    g = h.indexOf(W.a);
                    if ((h = -1 < g ? h[g + 1] : "") && f === e.ownerDocument) Rf(e, h, !0); else if (f.nodeType === Node.DOCUMENT_FRAGMENT_NODE &&
    ...
    if (!U) {
        ...
        if (window.customElements && !window.customElements.polyfillWrapFlushCallback) Rg(document); else {
            var Sg = function () {
                Rg(document.body)
            };
